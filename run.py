...
# basic config
# use_weight_dec
parser.add_argument('--use_weight_dec', action='store_true', required=False,
                    help='use_weight_dec')
parser.add_argument('--use_warm_up', action='store_true', required=False,
                    help='use_warm_up')
parser.add_argument('--warm_up_len', type=bool, required=False,
                    help='warm_up_len', default=0)
parser.add_argument('--warm_up_factor', type=bool, required=False,
                    help='warm_up_factor', default=0)
parser.add_argument('--weight_decay', type=float, required=False,
                    help='weight_decay', default=9e-06)
...
# parser.add_argument('--learning_rate', type=float, default=0.0001, help='optimizer learning rate')
parser.add_argument('--learning_rate', type=float, default=0.0009048000000000001, help='optimizer learning rate')
...
if args.is_training:
    for ii in range(args.itr):
        ...
        exp = Exp(args, weight_decay=args.weight_decay)  # set experiments
